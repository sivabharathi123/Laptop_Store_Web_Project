...
public class LaptopResource {
	...
	public Response addLaptop(Laptop laptop) {
		LaptopDAO.addLaptop(laptop.getProdtype(), laptop.getModel(), laptop.getBrand(), laptop.getPrice(),
				laptop.getProcessor(), laptop.getRam(), laptop.getHarddrive(), laptop.getThumbnail_url());
